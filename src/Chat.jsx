...
import { Container, Card, Icon, Form, Input, Message, Divider, Button } from 'semantic-ui-react'
...
const Chat = ({socket, username, room, setShowChat}) => {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            socket.off("userQuantity", handleQuantityOfUsers);
        }
    },[]);
                        ...
                        <Card.Content style={{height: "500px", padding: "5px"}}>
                            ...
                            return <span key={i}>
                                ...
                                <Message.Header key={i}>{m.message}</Message.Header>
                                    <p><strong>{m.author ? m.author : ""}</strong><i> ás {m.time}h</i></p>
                                </Message>
                                <Divider/>
                            </span> 
                            })}
